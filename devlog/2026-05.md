# DEVLOG — 2026-05 (archive)

Archived entries for **May 2026**, newest at the top. Part of the monthly
DEVLOG rotation; the live log is [`../DEVLOG.md`](../DEVLOG.md) (current month
+ the archive index). This file is append-frozen — new entries go in the live log.
